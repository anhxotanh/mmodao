...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=346814');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "346814");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "d3ce5d3a031b25d99733a335f4c38445e4acb43ca5eb7fcca7d05834f5a5c9f8");
define('CREATED_TIMESTAMP', "1609773375");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor346814');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor346814');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "mmodown.xyz",
));
